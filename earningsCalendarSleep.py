...
ALPHA_VANTAGE_API_KEY = 'XOZN1VKRUS8P4R6Z'
HORIZON = '12month'  # Adjust the horizon if needed
...
def main():
    for ticker in TICKERS:
        ...
        time.sleep(20)  # Sleep for 12 seconds between requests to avoid rate limits
